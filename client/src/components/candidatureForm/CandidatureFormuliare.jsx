...
import { FcBusinessContact, FcApproval, FcCallback, FcCalendar, FcRuler, FcContacts, FcAddressBook, FcGlobe, FcReadingEbook, FcPrevious, FcDisplay, FcMusic, FcLink, FcGenericSortingDesc, FcIdea, FcSelfie, FcConferenceCall, FcAdvertising, FcDribbble, FcFlashOn, FcRating } from "react-icons/fc";
import note from "../../components/img/note.png"
import confirm from "../../components/img/valide.png"
...
const CandidatureFormulaire = () => {
 ...
 const handleSubmit = async (e) => {
  const combinedFormData = {
    ...
    try {
      console.log(combinedFormData)
      const response = await axios.post(`http://localhost:8000/api/candidats/formulaire/${id}`, combinedFormData);
      console.log(response)
  ...
  const validateForm = () => {
    ...
    } else if (isNaN(formData.telephone) || formData.telephone < 10000000 || formData.telephone > 99999999) {
          ...
          <>
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                fontSize: '24px',
                marginBottom: '20px',
              }}>Formulaire de Candidature TACIR</h2>
                  ...
                  <div style={{ ...defaultStyle, ...transitionStyles[state] }}>
                    <form>
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        {errors.titre && <span style={errorStyle}>{errors.titre}</span>}
                        ...
                        {errors.descriptif && <span style={errorStyle}>{errors.descriptif}</span>}
                        ...
                        {errors.ideeProjet && <span style={errorStyle}>{errors.ideeProjet}</span>}
                        ...
                        {errors.lien && <span style={errorStyle}>{errors.lien}</span>}
                        ...
                        {errors.membres && <span style={errorStyle}>{errors.membres}</span>}
                        ...
                        {errors.aventure && <span style={errorStyle}>{errors.aventure}</span>}
                        ...
                        {errors.motivation && <span style={errorStyle}>{errors.motivation}</span>}
